if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){
    ...
    var namesExample = [
        ...
        "Suelle", "cuntlad", "BuyMyAids", "Wilihey", "Milkshook", "Kanker Luke", "SUCK YOUR MUM", "Acer", 
        "ChRoMoSoMe CoLlEcToR", "Deep-fried Daddy", "Deli Tuna", "Jordane", "W33d Goddess", "H3mp Goddess", 
        "Ben Dover", "Eileen Dover", "Suq Madiq", "Bita Negar", "Adolf_Hipster", "Fascist Deli", "Rusty Tromboner", 
        "ur search history", "actual dirt", "Adolphin", "Tana", "noggers are bad", "IceWallowCome", "Akane", 
        "Kareina", "IGassedJuice", "xDEFCONx", "Drazzle", "cuckling", "Dirty Dan", "Kat", "Ken", "SassySelty", "Ria", 
        "Yoru", "Korodo", "Meatbeater6000", "noihu", "Ryki", "Memes.DLL", "Unspeakable Yeet", "*unoriginal nickname*", 
        "a disappointment", "AUSHWITZ JUDEN '47", "bean swallow", "Belgian Fries", "Brandy", "Cumstain Catharsis", 
        "defective toe man", "Eikster", "FleetOfYeet", "Galactic Retard","Gudendrunk", "iwanttodie", "Kamibel", "Nyxan", 
        "scilz", "Dertixz", "Kaufee", "Gaslarga", "Gargix", "Nimmy Jeutron", "Sexy Vegan", "XXXTentacion", "XXXTerminated", 
        "Yharon", "XXXTinguished", "Sora", "3spooky5me", "Alcoholic Kitty", "Allarus", "Arima", "Baltazoiro", "Bayru", 
        "Brisingrvindr", "Captain Java", "D3SOLATION", "Darius", "Amy", "Arella", "Diet Coke", "Bepsis", "el conke", 
        "Erich Von Manstein", "Exodia", "Astaea", "Lindford", "Figueira", "foxburn", "go commit helpfulness", 
        "go commit tower jump", "go commit neck rope", "God", "Hypl3x", "Kaiser Wilhelm", "Kyrie", "Lunaria", 
        "Neutrix",  "Trisha", "Dante", "Lucy", "Nostalgion", "jail-bait", "not jail-bait", "Octopuss", "1-inch wonder", 
        "2-inch punisher", "Jewslayer69", "Pussyslayer9000", "Jewspanker6000", "Phynox", "sadist", "Shireen Mazari", 
        "shoot me", "Shrok", "Spitzkopf Larry", "T H U N D E R T H I G H S", "Taint Painter", "printf('Goodbye, world/n');", 
        "Microsoft Github", "thotdog", "thotimus prime", "BuildTheWall", "Shrauger", "Beloxy", "Virgina", "cucker", "Loak", 
        "Cancer.exe", "AIDS.DLL", "please send help", "Yavin", "Mars", "Jupiter", "Savitar", "Pluto", "Heinrich Himmler", 
        "Bastet", "Anubis", "ur mom big gay", "hi welcome to chilis", "Xx_W33B_xX", "Uranus", "begone thot", "domesticated thot", 
        "Puck Uranus", "Yuck Fou", "SilentMemer", "Mr. Ethnic Cleansing", "Scheibe", "cyka blyat", "Der Mist", "Geh Zum Teufel", 
        "Arschloch", "Arschgeige", "Dummkopf", "Wifebeater9000", "Karl Marx", "Puto", "Mierda", "clapping gorilla cheeks", 
        "Veegee", "Arason", "Furfag", "show bob and vegene", "Zoey", "Joey", "Cyrus", "Cynthia", "Meme Queen", "Robby Rotten", 
        "Sportacus", "Alfred", "Serena", "Tristan", "Andy", "Billy Beta",  "Zenny", "hi daddy", "Kim-Jung Uno", "Aphrodite", 
        "PAPA SNAKU", "100% Fascism", "Linux4Lyfe", "chrome big pp", "Brok3n", "AUTISM", "Cupcakes4Jesus", "Peter Porker", 
        "Boang Woman", "Republicunt", "DemocRAT", "Adderall.exe", "some object", "Pole Smoker", "Swamp Donkey", 
        "*Autistic Screech*", "Bong Huffer", "BAN ALL FURRIES", "Reefer", "SpankBank", "Swiggster", "Punani", "Swive", 
        "Felch", "W A N K E R", "Sernie Banders", "Covfefe", "Pickle Rick", "xX_Suicidal_Xx", "Asthma.exe", "Stiffy Knight", 
        "Claire", "Rump Ranger", "Elon Musk", "Elongated Muskrat", "Jim Crow", "Nayq", "Mordekai", "Bruno", "Gesely", 
        "bush did 9/11", "Bob Ross", "Communist Pubes", "Faguette", "Brit Jew", "Trotsky", "Sir Comcision", "Sshady", 
        "Sona", "liam_lee", "Trico", "Kirby", "pls begone", "im already tracer", "Dexter", "Soney", "Desperate Cheeto", 
        "Sonas's Shibe", "cunbwozr", "natzi", "lukebennett", "Grandfather Richard", "Krismine", "xYcLaS", "Shen Bapiro", 
        "0x0000C1F5", "Joller", "Ms. Steal Your Meme", "Ambien Effluvium", "bobby barnaclesauce", "cool vibrations", 
        "ghetto-gaser", "Monch", "Tymon.G0101", "<insert name>", "Abaddon the Harmless", "Dickard I", "doot", "E G G", 
        "I'm poor buy me now", "Jopatsu", "kev2468068", "Kowalex", "KriegsKatze", "Mint Enslaver", "Saint Codreanu", 
        "Reynauld", "spookuette", "Australia isn't real", "autistic lobster", "Baltazoiro", "BlickyTheSticky", "CypherFr", 
        "daborini mccheese", "Detriment to Society", "Disabled Donkey", "elmo is ready", "everyone below me is gay", 
        "everyone above me is gay", "Jocelyn", "octopussy", "Rapidity", "Shr00m", "Shrektus Memeington", "supreme allah", 
        "The Spaghet Monster", "choke me daddy", "yeet yeet potato skeet", "Weaseliovich", "you have homosexual", 
        "10 cm pp not small", "21Savage", "6 million wasnt enough", "99Ninety", "Zalaniro", "A7MED.27", "Alyenne", 
        "Alyrias", "arab-obama", "Autisify", "Bentleyyy", "Bitchard", "Birkenstock", "Blasty McSplodey", "bootylock", 
        "Cantillon", "ligmasurvivor", "Yggdrasil", "Brie", "Gassed Tea", "Caustic Goose", "flikersprigs",  "Malthius", 
        "Muskchops", "Kryptonik", "Beartikal", "Zyleak", "Voltaire", "Fetharis", "Byxes", "serelyy", "JustHail", "Lindford", 
        "Raviz", "Altheru", "cocolouis", "AssaultDragon55", "foxbattler1", "Croc_Gamer", "DaeshH", "CrazypersonfunXD", 
        "Geek_BO3", "harmcool",  "IZenrusI", "Inductive", "Lixer_YT", "PartiallyKnown", "Potting", "rockon8771", "KyraReaper", 
        "Soul_000", "AxisAngle", "Lunya", "Defaultio", "LordNobody", "The13thHippie", "Fraxium", "Velktor", "xTacticalBear", 
        "SC3PTRE", "Garlix", "KylieHuntress", "drainsights", "popsights", "Kavunal", "BlizzardReaper", "Wolfaxius", "Lancast", 
        "Pragmatist", "Polymorphic", "ColourTheory", "Optiics", "poisonlava", "kinglime", "Sigars13", "killer6199", "WizardGeometry", 
        "FractalGeometry", "RobotGeometry", "TwentyTwoPilots", "Ucalegen", "pwner195", "InnovatedFighting", "rockedison23", "Plebian", 
        "ZenMeteor", "TranscendantGlory", "Drazeox", "threedragons", "zepenguin4", "Jimnize", "DoctorSatan", "blocksniper", "Shirida", 
        "CptArcadia", "Valrath", "paul321321", "Shatteroni", "Mydrek", "p3el", "Aerolyte", "Frostaxius", "DystraTala", "WVFighter", 
        "nitroyoshi9", "parasights", "Leblancs", "RAAFighter", "ryanhero", "Surgo", "Scripth", "iroctheworld", "LordHammy", "EgoMoose", 
        "IllusionOfTruth", "Sharksie", "Living_Knightmare", "Anti_Cristus", "sk3let0n", "CrimsonForce", "Tori56780", "TrueSimplicity", 
