if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){
    ...
    var namesExample = ["Mohxy", "Vxire", "Gahmuret", "Tara", "Tomi", "Argor", "Kelretu", "Polyzynn", "Tekrala", "Kesta", "Suelle", "cuntlad", "BuyMyAids", "Wilihey", "Milkshook", "Kanker Luke", "SUCK YOUR MUM", "Acer", "ChRoMoSoMe CoLlEcToR", "Deep-fried Daddy", "Deli Tuna", "Jordane", "W33d Goddess", "H3mp Goddess", "Ben Dover", "Eileen Dover", "Suq Madiq", "Bita Negar", "Adolf_Hipster", "Fascist Deli", "Rusty Tromboner", "ur search history", "actual dirt", "Adolphin Hitler", "Tana", "noggers are bad", "IceWallowCome", "Akane", "Kareina", "IGassedJuice", "xDEFCONx", "Drazzle", "cuckling", "Dirty Dan", "Kat", "Ken", "SassySelty", "Ria", "Yoru", "Korodo", "Meatbeater6000", "noihu", "Ryki", "Memes.DLL", "Unspeakable Yeet", "unoriginal nickname", "a disappointment", "AUSHWITZ JUDEN '47", "bean swallow", "Belgian Fries", "Brandy", "Cumstain Catharsis", "defective toe man"];
    // var i;
    //i = 1;,
